    ...
    meals: [
      {
        ...
        note: "Cuire les flocons dans le lait, ajouter le beurre de cacahuète. Œufs brouillés ou à la poêle à côté.",
      },
      {
        name: "Collation matin",
        time: "10h00",
        items: [
          { food: "greekyogurt", qty: 170 },
          { food: "almonds", qty: 20 },
        ],
      },
      {
        ...
        items: [
          { food: "rice", qty: 130 },
          { food: "chicken", qty: 150 },
          { food: "broccoli", qty: 150 },
          { food: "oliveoil", qty: 10 },
        ],
        note: "Riz pesé cru (≈ 300g cuit). Assaisonner librement (épices, citron, sel).",
      },
      {
      ...
      },
      {
        ...
        time: "20h30",
        items: [
          { food: "sweetpotato", qty: 200 },
          { food: "cod", qty: 200 },
          { food: "veggies", qty: 200 },
          { food: "oliveoil", qty: 10 },
        ],
        note: "Remplacer le cabillaud par 150g de saumon 2x/semaine, ou 180g de viande rouge maigre 1x/semaine.",
      },
      {
        name: "Avant coucher",
        time: "22h00",
